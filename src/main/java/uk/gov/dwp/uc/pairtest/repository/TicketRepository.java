...
public class TicketRepository {
  ...
  public static List<Ticket> ticketProducts = List.of(new Ticket(Type.INFANT, BigDecimal.ZERO),
  ...
  public Ticket findPriceByTicketType(
      Type type) { // convenient method. Actual implementation mar require querying DB
    return ticketProducts.stream().filter(ticket -> ticket.ticketType().equals(type)).findFirst()
        .orElse(null);
  }
}
